...
namespace CNNInference {
	...
	public:
		...
		CNNInference::Matrix<float>* output_transposed;
	...
	private:
		...
		void im2row(Matrix<float>& images);
		void im2row_kernal(ThreeDimensionalArray* kernal, int in_c, int out_c, int ker_size);
	};
